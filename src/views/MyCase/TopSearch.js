...
class SearchInput extends React.Component {
   ...
   */
  caseNoInputChange(e) {
    this.props.myCaseAction.updMyCaseStateValue({ caseNo: e.target.value });
  }
  ...
  keywordInputChange(e) {
    this.props.myCaseAction.updMyCaseStateValue({ keyword_value: e.target.value });
  }
  ...
  clearSearch(e) {
    e.preventDefault();
    this.props.myCaseAction.clearMyCaseSearch(this.props.reqParams);
  }
  render() {
...
function mapStateToProps(state) {
  return {
    keyword_value: state.myCase.keyword_value,
    caseNo: state.myCase.caseNo,
